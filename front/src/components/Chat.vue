      ...
      <el-header>
        <!-- <el-row :gutter="20">
          ...
          <el-col :span="10" :offset="0">
            <el-card class="box-card">AI/GPT-3/text-davinci-003</el-card>
          </el-col>
          <el-col :span="7" :offset="0"></el-col>
        </el-row> -->
            ...
            <el-list-item v-for="message in messages" :key="message.id">
              <el-row v-if="message.isMine" class="msg-row">
                ...
                <el-col :span="22" style="display: flex; justify-content: flex-end">
                  <v-md-preview class="msg" height="10px" :text="message.text"></v-md-preview>
                </el-col>
                <el-col :span="1" style="display: flex; justify-content: flex-end;">
                  <el-avatar shape= "square" size="small" :src="userAvatarUrl" @error="errorHandler" />
                </el-col>
              </el-row>
              <el-row v-else class="msg-row">
                <el-col :span="1" style="display: flex; justify-content: flex-start;">
                  <el-avatar shape= "square" size="small" :src="aiAvatarUrl" @error="errorHandler" />
                </el-col>
                <el-col :span="22" style="display: flex; justify-content: flex-start">
                  <v-md-preview class="msg-ai" :text="message.text"></v-md-preview>
                </el-col>
                <el-col :span="1"> </el-col>
              </el-row>
            </el-list-item>
      ...
      <el-footer>
        <el-form :model="form" class="msg-form" @submit.native.prevent>
          <el-row :gutter="5">
            <el-col :span="20">
              <el-form-item>
                <el-input class="chat-input" v-model="form.message" rows="2" maxlength="100" show-word-limit
                  :disabled="disableForm" @keyup.enter.native="checkTextLen()" :placeholder="placeHolder" />
              </el-form-item>
            </el-col>
            <el-col :span="4">
              <el-form-item>
...
content="this is content, this is content, this is content">
                <template #reference> -->
                <el-button class="send-btn" @click="checkTextLen()" icon="Position" :disabled="disableForm"
                  :loading="disableForm" color="#30b987a1" type="primary">{{ sendBtnText }}</el-button>
<!-- </template>
                </el-popover> -->
              </el-form-item>
            </el-col>
...
export default {
  data() {
    return {
      ...
      // aiAvatarUrl:
      //   "https://media.istockphoto.com/id/1460489368/vector/chatbot-logo-with-robot-head-chatbot-icon-artificial-intelligence-openai-openai-icon.jpg?b=1&s=170x170&k=20&c=vFpDX5gMY5MLAXxdSmSO8WCLaVivx89kPI_gG-YLlQg=",
      aiAvatarUrl:
  ...
  methods: {
    generatePrompt() {
      ...
      if (this.messages.length > 20){
        for (let index = this.messages.length - 20 ; index < this.messages.length; index++) {
    ...
    sendMessage() {
      ...
      fetch("https://api.openai.com/v1/completions", {
        ...
        headers: {
          ...
          Authorization:
            " Bearer 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",
        },
        body: JSON.stringify({
      ...
      //   method: "POST",
      //   headers: { 'Content-Type': 'application/json', 'Authorization':' Bearer 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' },
      //   body: JSON.stringify({
